...
void SolveSlauGaussa(complex<float> **matrix_A, size_t dimensionMatrix, complex<float> *matrix_b, complex<float> *exactSolution)
{
	...
	{
		float maxString = abs(basicMatrix[k][k]);
		size_t maxNomerInString = k;
